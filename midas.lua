if IY_LOADED and not _G.IY_DEBUG then
	-- error("MIDAS is already running!", 0)
	return
end
...
local iyassets = {
	...
	["midas/assets/close.png"] = "rbxassetid://5054663650",
	["midas/assets/editaliases.png"] = "rbxassetid://5147488658",
	["midas/assets/editkeybinds.png"] = "rbxassetid://129697930",
	["midas/assets/edittheme.png"] = "rbxassetid://4911962991",
	["midas/assets/editwaypoints.png"] = "rbxassetid://5147488592",
	["midas/assets/imgstudiopluginlogo.png"] = "rbxassetid://4113050383",
	["midas/assets/logo.png"] = "rbxassetid://75972699875615",
	["midas/assets/minimize.png"] = "rbxassetid://2406617031",
	["midas/assets/pin.png"] = "rbxassetid://6234691350",
	["midas/assets/reference.png"] = "rbxassetid://3523243755",
	["midas/assets/settings.png"] = "rbxassetid://1204397029"
}
...
if makefolder and isfolder and writefile and isfile then
	pcall(function() -- good executor trust
		...
		for _, folder in {"midas", "midas/assets"} do
		...
		for path in iyassets do
			if not isfile(path) then
				writefile(path, game:HttpGet((path:gsub("midas/", assets))))
			end
		end
		if IsOnMobile then writefile("midas/assets/.nomedia", "") end
	end)
end
...
Title.TextSize = 18
Title.Text = "MIDAS v" .. currentVersion
...
SettingsButton.Image = getcustomasset("midas/assets/settings.png")
...
ReferenceButton.Image = getcustomasset("midas/assets/reference.png")
...
ColorsButton = makeSettingsButton("Edit Theme",getcustomasset("midas/assets/edittheme.png"))
ColorsButton.Position = UDim2.new(0, 5, 0, 55)
ColorsButton.Size = UDim2.new(1, -10, 0, 25)
ColorsButton.Name = "Colors"
ColorsButton.Parent = SettingsHolder

Keybinds = makeSettingsButton("Edit Keybinds",getcustomasset("midas/assets/editkeybinds.png"))
Keybinds.Position = UDim2.new(0, 5, 0, 85)
Keybinds.Size = UDim2.new(1, -10, 0, 25)
Keybinds.Name = "Keybinds"
Keybinds.Parent = SettingsHolder

Aliases = makeSettingsButton("Edit Aliases",getcustomasset("midas/assets/editaliases.png"))
...
Positions = makeSettingsButton("Edit/Goto Waypoints",getcustomasset("midas/assets/editwaypoints.png"))
Positions.Position = UDim2.new(0, 5, 0, 145)
Positions.Size = UDim2.new(1, -10, 0, 25)
Positions.Name = "Waypoints"
Positions.Parent = SettingsHolder

EventBind = makeSettingsButton("Edit Event Binds",getcustomasset("midas/assets/bindsandplugins.png"),759)
EventBind.Position = UDim2.new(0, 5, 0, 205)
EventBind.Size = UDim2.new(1, -10, 0, 25)
EventBind.Name = "EventBinds"
EventBind.Parent = SettingsHolder

Plugins = makeSettingsButton("Manage Plugins",getcustomasset("midas/assets/bindsandplugins.png"),743)
...
CloseImage.Image = getcustomasset("midas/assets/close.png")
...
PinImage.ZIndex = 10
PinImage.Image = getcustomasset("midas/assets/pin.png")
...
Logo.Image = getcustomasset("midas/assets/logo.png")
...
ExitImage_2.Image = getcustomasset("midas/assets/close.png")
...
Img.Image = getcustomasset("midas/assets/imgstudiopluginlogo.png")
Img.ZIndex = 10
...
ExitImage_3.Image = getcustomasset("midas/assets/close.png")
...
PluginsHint.Text = "Download plugins from the MIDAS Discord (discord.gg/CrNCnc7pYT)"
...
ExitImage_5.Image = getcustomasset("midas/assets/close.png")
...
ImageLabel.Image = getcustomasset("midas/assets/minimize.png")
...
ImageLabel_2.Image = getcustomasset("midas/assets/close.png")
...
eventEditor = (function()
	...
	local main = create({
		...
		{5,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Image=getcustomasset("midas/assets/close.png"),Parent={4},Position=UDim2.new(0,5,0,5),Size=UDim2.new(0,10,0,10),ZIndex=10,}},
		...
		{53,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Image=getcustomasset("midas/assets/settings.png"),Parent={52},Position=UDim2.new(0,2,0,2),Size=UDim2.new(0,16,0,16),ZIndex=10,}},
	})
	main.Name = randomString()
...
reference = (function()
	local main = create({
		...
		{114,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Text",Parent={112},Position=UDim2.new(0,8,0,30),Size=UDim2.new(1,-8,0,32),Text="You can join the Discord server to get support with MIDAS, and read up on more documentation such as the Plugin API.",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
	...
	inviteButton.MouseButton1Click:Connect(function()
		if everyClipboard then
			toClipboard("https://discord.gg/CrNCnc7pYT")
		...
		inviteButton.Text = "Copy Discord Invite Link (https://discord.gg/CrNCnc7pYT)"
	end)
	dragGUI(main)
	main.Parent = ScaledHolder
...
function createPopup(title, text)
	...
	ExitImage.Image = getcustomasset("midas/assets/close.png")
	ExitImage.ZIndex = 10
...
function saves()
	if writefileExploit() and readfileExploit() and jsonAttempts < 10 then
		local readSuccess, out = readfile("MIDAS.iy", true)
		if readSuccess then
			if out ~= nil and tostring(out):gsub("%s", "") ~= "" then
				...
				if not success then
					...
					writefile("MIDAS.iy", defaults, true)
					wait()
					saves()
				end
			else
				writefile("MIDAS.iy", defaults, true)
				wait()
				local dReadSuccess, dOut = readfile("MIDAS.iy", true)
...
function updatesaves()
	if nosaves == false and writefileExploit() then
		...
		writefileCooldown("MIDAS.iy", HttpService:JSONEncode(update))
	end
end
...
SaveChatlogs.MouseButton1Down:Connect(function()
	if writefileExploit() then
		if #scroll_2:GetChildren() > 0 then
			...
			local writelogs = '-- MIDAS Chat logs for "'..placeName..'"\n'
			for _, child in pairs(scroll_2:GetChildren()) do
				writelogs = writelogs..'\n'..child.Text
			end
...
CMDs = {}
CMDs[#CMDs + 1] = {NAME = 'discord / support / help', DESC = 'Invite to the MIDAS discord server.'}
...
CMDs[#CMDs + 1] = {NAME = 'hidemidas', DESC = 'Hides the main MIDAS GUI'}
CMDs[#CMDs + 1] = {NAME = 'showmidas / unhidemidas', DESC = 'Shows MIDAS again'}
CMDs[#CMDs + 1] = {NAME = 'keepmidas', DESC = 'Auto execute MIDAS when you teleport through servers'}
CMDs[#CMDs + 1] = {NAME = 'unkeepmidas', DESC = 'Disable keepmidas'}
CMDs[#CMDs + 1] = {NAME = 'togglekeepmidas', DESC = 'Toggles keepmidas'}
...
function addPlugin(name)
	if name:lower() == 'plugin file name' or name:lower() == 'midas.iy' or name == 'midas' then
...
addcmd('discord', {'support', 'help'}, function(args, speaker)
	if everyClipboard then
		toClipboard('https://discord.com/invite/CrNCnc7pYT')
		notify('Discord Invite', 'Copied to clipboard!\ndiscord.gg/CrNCnc7pYT')
	else
		notify('Discord Invite', 'discord.gg/CrNCnc7pYT')
	end
	if httprequest then
		httprequest({
			...
			Body = HttpService:JSONEncode({
				...
				args = {code = 'CrNCnc7pYT'}
			})
		})
	end
end)

addcmd('keepmidas', {'keepiy'}, function(args, speaker)
	if queueteleport then
		KeepInfYield = true
		notify('KeepMIDAS','MIDAS will now run after you teleport')
		updatesaves()
	else
...
addcmd('unkeepmidas', {'unkeepiy'}, function(args, speaker)
	if queueteleport then
		KeepInfYield = false
		notify('KeepMIDAS','MIDAS will no longer run after you teleport')
		updatesaves()
	else
		notify('Incompatible Exploit','Your exploit does not support this command (missing queue_on_teleport)')
	end
...
addcmd('togglekeepmidas', {'togglekeepiy'}, function(args, speaker)
	if queueteleport then
...
addcmd('hidemidas',{'hideiy'},function(args, speaker)
	isHidden = true
	...
	minimizeNum = 0
	minimizeHolder()
	if not (args[1] and tostring(args[1]) == 'nonotify') then notify('MIDAS Hidden','You can press the prefix key to access the command bar') end
end)

addcmd('showmidas',{'showiy','unhideiy','unhidemidas'},function(args, speaker)
	isHidden = false
	minimizeNum = -20
	if wasStayOpen then
		maximizeHolder()
